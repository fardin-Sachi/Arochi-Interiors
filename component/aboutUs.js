  ...
  return (
    <section id="about" className="pb-20 py-10">
      <div className="hover:scale-115 duration-300">
        ...
        <hr className='w-56 h-1 mx-auto bg-gray-400 border-0 rounded-sm ' />
      </div>
      <p className="text-justify font-[poppins] p-4 px-20 text-xl">
